...
The repo is **not yet public** (`github.com/mcmayank/open-commerce` returns 404).
Until it is, claim the **licence**, which is true and verifiable, not the browsing.

- ✅ "MIT-licensed. Self-host the single-store build free, forever."
- ❌ "Read and fork every line." / "Browse the repo." / "You can check every claim
  on this page yourself" attached to a link that 404s.
