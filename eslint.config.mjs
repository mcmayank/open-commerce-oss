// ESLint config for the public single-store repository. Shipped by the export
// (oss/eslint.config.mjs in the private repo); edit it there. It is the private
// config minus the core/hosted boundary rule, which has nothing to guard here.
