...
import type { requestReset, ForgotState } from './actions'

interface ForgotFormProps {
  action: typeof requestReset
}

export default function ForgotForm({ action }: ForgotFormProps) {
  const [state, formAction, isPending] = useActionState<ForgotState, FormData>(action, null)
